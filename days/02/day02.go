...
func Part1(instructions []string) string {
	var keyToNextKey = map[string]map[string]string{
		"1": {"U": "1", "R": "2", "D": "4", "L": "1"},
		"2": {"U": "2", "R": "3", "D": "5", "L": "1"},
		"3": {"U": "3", "R": "3", "D": "6", "L": "2"},
		"4": {"U": "1", "R": "5", "D": "7", "L": "4"},
...
func calculate(instructions []string, keyToNextKey map[string]map[string]string) string {
	res := ""
	cur := "5"

	for _, instr := range instructions {
		for _, ch := range instr {
			cur = keyToNextKey[cur][string(ch)]
		}
